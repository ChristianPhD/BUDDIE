...
navbarPage(
  ...
  # This section is used to describe all of the independent, dependent, and demographic variables used in the tool
  tabPanel(
    value = "graphvariabletab",
    "Graph Variable Description",
    fluidPage(
      theme = shinytheme("flatly"),
      title = "Graph Variable Description",
      mainPanel(
        width = 12,
        h1("Variable Description",
           style = "font-family: Helvetica; font-size: 30px; color: #2B3E51"
        ),
        strong("Graphical Information",
               style = "font-family: Helvetica; font-size: 20px; color:  #2B3E51"
        ),
        p("This page is related to the variables of graphs and tells about their description.",
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        p(" ", br(), style = "line-height: .25"),
        p("Scale Key",
  ...
  tabPanel(
    ...
    fluidPage(
      ...
      mainPanel(
        ...
        tags$ul(
          tags$li("Social Context Assessment of Learning Environment - This modified version of the SCALE measures general relations between students and instructors where students take on roles as learners or instructors. Original authors: J.D. Walker & Paul Baepler in 2016."),
          tags$li("There are variables scale1 to scale 12 which are graphed with other dependent or independent variables."),
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        p(" ", br(), style = "line-height: .25"),
        p("Modified SALG",
        ...
        tags$ul(
          tags$li("Student Assessment of Learning Gains - This modified assessment measures the students' confidence in performing a variety of tasks commonly associated with learning goals of science courses.
                  Original authors: Sehoya Cotner, Cissy Ballen, D. Christopher Brooks, and Randy Moore in the Journal of College Science Teaching in 2011, Volume 40, Issue 5."),
          tags$li("There are variables from c1 through c10 which are graphed with other variables"),
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        p(" ", br(), style = "line-height: .25"),
        p("MSLQ",
        ...
        tags$ul(
          tags$li("Motivational and Self-Regulated Learning Questionnaire - Measures motivational beliefs (self-efficacy, intrinsic value, and test anxiety) and self-regulated learning strategies (cogntitive strategies and self-regulation). As administered, only the intrinsic value and test anxiety (motivational beliefs) and self-regulation (self-regulated learning strategies) scales were used. 
                  Original authors: Paul Pintrich & Elisabeth V. DeGroot in the Journal of Educational Psychology, Volume 90, Issue 1, in 1990."),
          tags$li("There are variables from mslq1 through mslq20 which are graphed with other variables"),
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        ...
        tags$ul(
          tags$li("Social Identities and Attitudes Scale - This scale measures stereotype threat and identity aspects as they relate to the classroom from the perspective of individual students. 
                  Original author: Katherine Picho & Scott Brown in the Journal of Advanced Academics, Volume 22, Issue 3 in 2011."),
          tags$li("There are variables from st1 through st23 which are graphed with other variables"),
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        
        p(" ", br(), style = "line-height: .25"),
        strong("X-Axis: Grade.Percent",
               style = "font-family: Helvetica; font-size: 20px; color:  #2B3E51"
        ),
        p("Independent variable with student's grades expressed as percent.",
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        p(" ", br(), style = "line-height: .25"),
        p("Y-Axis:",
        ...
        tags$ul(
          tags$li("Grade.percent: Dependent variable with student's grade expressed as percent."),
          tags$li("Exam1.Percent: Grades of Exam1 of students as percentage."),
          tags$li("Exam2.Percent: Grades of Exam2 of students as percentage."),
          tags$li("Exam3.Percent: Grades of Exam3 of students as percentage."),
          tags$li("Exam4.Percent: Grades of Exam4 of students as percentage."),
          tags$li("Final.Exam.Percent: Grades of Final exam of students as percentage."),
          tags$li("Avg.Exams.Percent: Average of Grades of students as percentage."),
          tags$li("Lecture.Percent: Percentage of exams and anyother testings in a lecture as percetage."),
          tags$li("Age: Age of the students scoring in an exam depending upon their level of understanding."),
          tags$li("For all other varialbles We cannot display a graph with a numeric independent variable and a categorical dependent variable. We need to select either a categorical 
                  independent variable in addition to the categorical dependent variable or a continuous dependent variable."),
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        p(" ", br(), style = "line-height: .25"),
        strong("X-Axis: Grade.Letter",
               style = "font-family: Helvetica; font-size: 20px; color:  #2B3E51"
        ),
        p("Independent variable with student's grades in the form of letter.",
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        p(" ", br(), style = "line-height: .25"),
        p("Y-Axis:",
        ...
        tags$ul(
          tags$li("Grade.Percent: students grade in terms of percent"),
          tags$li("Grade.Letter: dependent variable with student's grades in the form of letter."),
          tags$li("Exam1, Exam2, Exam3, Exam4.percent: Grades of exam 1,2,3,4 as percent."),
          tags$li("Final.Exam.Percent: Grades of Final exam of students as percentage."),
          tags$li("Avg.Exams.Percent: Average of Grades of students as percentage."),
          tags$li("Lecture.Percent: Percentage of exams and anyother testings in a lecture as percetage."),
          tags$li("c1: Discuss scientific concepts with my friends or family"),
        ...
        p(" ", br(), style = "line-height: .25"),
        strong("X-Axis: Exam1.Percent, Exam2.Percent, Exam3.Percent, Exam4.Percent",
               style = "font-family: Helvetica; font-size: 20px; color:  #2B3E51"
        ),
        p("Grades of students for different exams which are taken as indepenent variables and are plotted against various dependent variables to check the distribution for analysis.",
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        p(" ", br(), style = "line-height: .25"),
        p("Y-Axis: ",
        ...
        p(" ", br(), style = "line-height: .25"),
        strong("X-Axis: Final.Exam.Percent, Avg.Exam.Percent, Lecture.Percent",
               style = "font-family: Helvetica; font-size: 20px; color:  #2B3E51; line-height: 0.1"
        ),
        p("Final exam grades of students along with the avg of all the exams, and the (assignments or homeworks) for lecture variables are taken to plot against the various variables available in the data set.",
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        p(" ", br(), style = "line-height: .25"),
        p("Y-Axis: ",
        ...
        p("All the independent variables from c1 through c10 are plotted against the dependent variables and are analysed for futher progress.",
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        p(" ", br(), style = "line-height: .25"),
        p("Y-Axis:",
        ...
        p(" ", br(), style = "line-height: .25"),
        strong("X-Axis: MSLQ1 to MSLQ20",
               style = "font-family: Helvetica; font-size: 20px; color:  #2B3E51; line-height: 0.1"
        ),
        p("All the independent variables from MSLQ1 through MSLQ20 are plotted against the dependent variables and are analysed for futher progress.For MSLQ details you may visit the Glossary page",
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        p(" ", br(), style = "line-height: .25"),
        p("Y-Axis:",
        ...
        p(" ", br(), style = "line-height: .25"),
        strong("X-Axis: Scale1 to Scale12",
               style = "font-family: Helvetica; font-size: 20px; color:  #2B3E51"
        ),
        p("All the independent variables from Scale1 through Scale12 are plotted against the dependent variables and are analysed for futher progress.For Scale variables details you may visit the Glossary page",
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        p(" ", br(), style = "line-height: .25"),
        p("Y-Axis:",
        ...
        p("All these are some genreal variables like age, gender, year, color eyc which have impact on the data set provided. All these variables are considered and the plots are against the same dependent variables used for the above cases. Each
          and every independet variables is mapped with the dependent varibales and the resultant plots are used for analysis. There are some cases where independent variables are mapped with independent variables
          to makesure that this possibility was not excluded.",
          style = "font-family: Helvetica; font-size: 14px; color:  #2B3E51"
        ),
        tags$ul(
          tags$li("Age: Age of the students scoring in an exam depending upon their level of understanding."),
